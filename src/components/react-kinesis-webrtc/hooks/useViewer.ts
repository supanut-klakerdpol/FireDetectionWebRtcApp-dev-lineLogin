...
export  function useViewer(
  ...
  console.log("Passed Config", config.channelARN)
  console.log("Passed Config", signalingChannelEndpoints)

  var { error: signalingChannelEndpointsError, signalingChannelEndpoints, resetSignalingChannelEndpoints} =   useSignalingChannelEndpoints({
      channelARN,
      kinesisVideoClient,
      role,
    });
  
  console.log("Passed Config 2nd", config.channelARN)
  console.log("Passed Config 2nd", signalingChannelEndpoints)
  ...
  useEffect(() => {
    resetSignalingChannelEndpoints()
    if (!iceServers) {
      return;
    }
  ...
  useEffect(() => {
    ...
    function handleConnectionChange() {
      ...
      if (peerConnection?.connectionState === "failed") {
        ...
        console.log("reset")
        signalingChannelEndpoints = undefined
        console.log("after reset", signalingChannelEndpoints)
        resetSignalingChannelEndpoints();
      }
    }
